...
import { GameResult, GameResultService } from '../game-result';
...
export class GameDialogComponent implements OnInit {
    ...
    ngOnInit() {
        this.isSaving = false;
        this.gameResultService.query()
            .subscribe((res: ResponseWrapper) => { this.gameresults = res.json; }, (res: ResponseWrapper) => this.onError(res.json));
    }
    ...
    trackGameResultById(index: number, item: GameResult) {
        return item.id;
    }
}
