...
describe('Service Tests', () => {
    ...
    describe('GameResult Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(GameResultService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/game-results/' + 123);
            });
            it('should return GameResult', () => {

                let entity: GameResult;
                service.find(123).subscribe((_entity: GameResult) => {
                    entity = _entity;
                });
