package io.fuz.fuzgateway.repository;

import io.fuz.fuzgateway.FuzgatewayApp;
import io.fuz.fuzgateway.config.Constants;
import io.fuz.fuzgateway.config.audit.AuditEventConverter;
import io.fuz.fuzgateway.domain.PersistentAuditEvent;
...
import static io.fuz.fuzgateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
