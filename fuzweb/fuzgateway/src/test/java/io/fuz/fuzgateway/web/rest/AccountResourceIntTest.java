...
import io.fuz.fuzgateway.FuzgatewayApp;
import io.fuz.fuzgateway.domain.Authority;
import io.fuz.fuzgateway.domain.User;
import io.fuz.fuzgateway.repository.AuthorityRepository;
...
import io.fuz.fuzgateway.web.rest.errors.ExceptionTranslator;
import io.fuz.fuzgateway.web.rest.vm.KeyAndPasswordVM;
...
@SpringBootTest(classes = FuzgatewayApp.class)
