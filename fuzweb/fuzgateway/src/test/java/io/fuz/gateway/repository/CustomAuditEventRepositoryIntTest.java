package io.fuz.gateway.repository;

import io.fuz.gateway.FuzgatewayApp;
import io.fuz.gateway.config.Constants;
import io.fuz.gateway.config.audit.AuditEventConverter;
import io.fuz.gateway.domain.PersistentAuditEvent;
...
import static io.fuz.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
