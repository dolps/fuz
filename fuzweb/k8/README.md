...
```
$ docker image tag fuzgateway dolpfuz/fuzgateway
$ docker push dolpfuz/fuzgateway
$ docker image tag fuzmicros dolpfuz/fuzmicros
$ docker push dolpfuz/fuzmicros
```
...
$ kubectl apply -f fuzgateway
$ kubectl apply -f fuzmicros
```
