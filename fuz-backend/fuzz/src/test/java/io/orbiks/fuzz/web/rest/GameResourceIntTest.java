package io.orbiks.fuzz.web.rest;

import io.orbiks.fuzz.FuzzApp;

import io.orbiks.fuzz.domain.Game;
import io.orbiks.fuzz.repository.GameRepository;
import io.orbiks.fuzz.service.GameService;
import io.orbiks.fuzz.service.dto.GameDTO;
import io.orbiks.fuzz.service.mapper.GameMapper;
import io.orbiks.fuzz.web.rest.errors.ExceptionTranslator;
...
import static io.orbiks.fuzz.web.rest.TestUtil.sameInstant;
...
@SpringBootTest(classes = FuzzApp.class)
public class GameResourceIntTest {
    ...
    public static Game createEntity(EntityManager em) {
        Game game = new Game()
            ...
            .datePlayed(DEFAULT_DATE_PLAYED);
        return game;
    }
    ...
    public void createGame() throws Exception {
        ...
        assertThat(testGame.getDatePlayed()).isEqualTo(DEFAULT_DATE_PLAYED);
    }
    ...
    @Test
    @Transactional
    public void checkDatePlayedIsRequired() throws Exception {
        int databaseSizeBeforeTest = gameRepository.findAll().size();
        // set the field null
    ...
    public void updateGame() throws Exception {
        ...
        updatedGame
            ...
            .datePlayed(UPDATED_DATE_PLAYED);
        ...
        assertThat(testGame.getDatePlayed()).isEqualTo(UPDATED_DATE_PLAYED);
    }
