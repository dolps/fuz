...
export class GameService {
    ...
    private resourceUrl = '/fuzz/api/games';
    ...
    private convertItemFromServer(json: any): Game {
        ...
        entity.datePlayed = this.dateUtils
            .convertDateTimeFromServer(json.datePlayed);
        return entity;
    }
    ...
    private convert(game: Game): Game {
        ...
        copy.datePlayed = this.dateUtils.toDate(game.datePlayed);
        return copy;
    }
}
