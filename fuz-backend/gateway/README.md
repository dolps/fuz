...
To optimize the fuzgateway application for production, run:
...
[Service Discovery and Configuration with Consul]: http://www.jhipster.tech/documentation-archive/v4.10.0/microservices-architecture/#consul
